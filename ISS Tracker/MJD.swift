...
class MJD {
  ...
  static func mjdFromMonths(months: Int, days: Double, years: Int) -> Double {
    var m = months
  ...
  static func monthsDaysYearsFromMjd(mjd: Double) -> (months: Int, days: Double, years: Int) {
    var months = 0
    var days = 0.0
    var years = 0
  ...
  static func yearFromMjd(mjd: Double) -> Double {
  ...
  static func yearsDaysFromMjd(mjd: Double) -> (years: Int, days: Double) {
  ...
  static func mjdFromDate(date: NSDate) -> Double {
